        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Built by leaders who have <span className="text-primary-gradient">navigated complexity</span> before
            </h1>
            ...
            <div className="p-5 sm:p-8">
              ...
              <div className="pt-5 border-t border-border">
                <a
                  ...
                  className="inline-flex items-center text-primary hover:text-primary/70 active:text-primary/70 transition-colors duration-200"
                >
